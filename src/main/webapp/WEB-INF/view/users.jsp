...
<div id="userAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/page/user-add.action'" style="width:800px;height:600px;padding:10px;">
        The window content.
</div>
<div id="userEdit" class="easyui-window" title="修改会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/page/user-edit.action'" style="width:800px;height:600px;padding:10px;">
	The window content.
</div>
